 ...
 */ !(function(t) {
      ...
      var f = (function(t, e, n) {
        ...
        L = function(t) {
          ...
          for (e = 0; e < N.length; e++)
            if ((n = N[e] + r) in b.style) return { dom: n, css: C[e] + t };
        },
        w = (e.support = {
      ...
      var D = (e.frame = (function() {
        ...
        F = f(function(e) {
          ...
          (e.init = function(e) {
            ...
            T("stop", u),
            T("set", function(t) {
              u.call(this, t), E.call(this, t, h, I);
            }),
            T("show", function(t) {
  ...
  function(t, e, n) {
    ...
    function ct(t, e) {
      ...
      if (
        ...
        f &&
          d &&
          e.dispatch(
            (0, T.actionListPlaybackChanged)({ actionListId: r, isPlaying: !u })
          );
      }
    }
    function st(t, e) {
                        ...
                        if ((0, f.default)(d)) {
                          (0, p.default)(d, function(t, e) {
                            ...
                            (a.actionTypeId === x || ut(a.actionTypeId)) &&
                              Tt({ store: n, actionListId: p, eventId: f });
                          });
                          var E = function(t) {
                              var e = n.getState(),
                                r = e.ixSession;
                  ...
                  (function(t) {
                    ...
                    pt.forEach(function(n) {
                      window.addEventListener(n, e),
                        t.dispatch((0, T.eventListenerAdded)(window, [n, e]));
                    }),
                      e();
                  })(t);
            })(n),
            -1 === (e = document.documentElement).className.indexOf(L) &&
    ...
    function dt(t) {
      ...
      e.active &&
        (e.eventListeners.forEach(Et), t.dispatch((0, T.sessionStopped)()));
    }
    function Et(t) {
      var e = t.target,
        n = t.listenerParams;
    ...
    function vt(t) {
      ...
      if (i !== n.viewportWidth) {
        ...
        t.dispatch((0, T.viewportWidthChanged)({ width: i, mediaQueries: o }));
      }
    }
    var ht = function(t, e) {
      ...
      if (f && f.useFirstGroupAsInitialState) {
        ...
        l.forEach(function(t) {
          ...
          a.forEach(function(i) {
            ...
            mt({
              destination: G({ element: i, actionItem: t, elementApi: g }, a),
              immediate: !0,
              store: e,
              element: i,
              eventId: r,
    ...
    function Ot(t) {
      var e = t.store,
        ...
        u = a.ixInstances,
        c =
          a.ixSession.hasBoundaryNodes && r ? g.getClosestElement(r, b) : null;
    ...
    function yt(t) {
      ...
      u >= I.length && (0, s.default)(p, "config.loop") && (u = 0),
        0 === u && T && u++;
      var O =
          (0 === u || (1 === u && T)) && ut(p.action && p.action.actionTypeId)
            ? p.config.delay
            : void 0,
        y = (0, s.default)(I, [u, "actionItems"], []);
      if (!y.length) return !1;
      if (!K(h, E.mediaQueryKey)) return !1;
      var m = E.hasBoundaryNodes && r ? g.getClosestElement(r, b) : null,
        S = W(y),
        A = !1;
      return (
          ...
          if (E) {
            ...
            M({
              ...
              var h = S === a && 0 === E,
                ...
                I = G({ element: s, actionItem: t, elementApi: g }, p);
              mt({
                store: e,
                element: s,
                actionItem: t,
    ...
    function mt(t) {
      ...
      e.dispatch(
        (0, T.instanceAdded)(
          (0, a.default)(
            { instanceId: l, elementId: v, origin: I, refType: _ },
            r
          )
        )
      ),
        ...
        s
          ? (function(t, e) {
              ...
              t.dispatch((0, T.instanceStarted)(e, 0)),
                t.dispatch((0, T.animationFrameChanged)(performance.now(), n)),
    ...
    function St(t, e) {
      ...
      var n = t.elementId,
        ...
        o = i.ref;
      i.refType === N && Q(o, r, g), e.dispatch((0, T.instanceRemoved)(t.id));
    }
    function At(t, e, n) {
    ...
    function Rt(t, e) {
      var n = t.active,
        ...
        A = void 0 === S ? y.mediaQueryKeys : S;
      if (K(A, m.mediaQueryKey) && (r || n || i)) {
        if (s || (c === C && i)) {
  ...
  function(t, e, n) {
    n(100), n(102), n(54), n(104), n(259), n(260), n(261), (t.exports = n(262));
  },
  function(t, e, n) {
    "use strict";
    var r = n(5);
          ...
          return function(e) {
            e
              ? ((e.thirdPartyCookiesSupported = t),
                E(v(e.bugReporterScriptPath), function() {
    ...
    t.exports = function(t, e, n, u) {
      ...
      for (; ++c < s; ) {
        ...
        if (f && l[2]) {
          ...
          var v = new r();
          if (u) var h = u(E, p, d, t, e, v);
          if (!(void 0 === h ? i(p, E, o | a, u, v) : h)) return !1;
        }
      }
      return !0;
    };
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, h, _, I) {
      ...
      if (A && !m)
        return (
          I || (I = new r()),
          T || f(t) ? i(t, e, n, h, _, I) : o(t, e, O, n, h, _, I)
        );
      if (!(n & l)) {
        var R = m && v.call(t, "__wrapped__"),
          b = S && v.call(e, "__wrapped__");
        if (R || b) {
          var N = R ? t.value() : t,
            C = b ? e.value() : e;
          return I || (I = new r()), _(N, C, n, h, I);
        }
      }
      return !!A && (I || (I = new r()), a(t, e, n, h, _, I));
    };
  },
  function(t, e, n) {
    var r = n(33),
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, r, y, S, A) {
      switch (n) {
        case O:
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n, a, u, c) {
      ...
      for (var h = s; ++d < l; ) {
        var _ = t[(E = f[d])],
          I = e[E];
        if (a) var T = s ? a(I, _, E, e, t, c) : a(_, I, E, t, e, c);
        if (!(void 0 === T ? _ === I || u(_, I, n, a, c) : T)) {
          v = !1;
          break;
        }
        h || (h = "constructor" == E);
  ...
  function(t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        switch (i) {
          ...
          case g.STYLE_SIZE:
            var s = r.getStyle,
              ...
              h = v.widthValue,
              T = v.heightValue;
            if (!O.IS_BROWSER_ENV) return { widthValue: h, heightValue: T };
            if (E === I.AUTO) {
              var y = s(e, I.WIDTH);
              f(e, I.WIDTH, ""), (h = l(e, "offsetWidth")), f(e, I.WIDTH, y);
            }
            if (p === I.AUTO) {
              var m = s(e, I.HEIGHT);
              f(e, I.HEIGHT, ""), (T = l(e, "offsetHeight")), f(e, I.HEIGHT, m);
            }
            return { widthValue: h, heightValue: T };
          case g.STYLE_BACKGROUND_COLOR:
          case g.STYLE_BORDER:
          case g.STYLE_TEXT_COLOR:
            var S = n.config,
              ...
              b = S.bValue,
              N = S.aValue;
            return { rValue: A, gValue: R, bValue: b, aValue: N };
          case g.STYLE_FILTER:
      ...
      (e.cleanupHTMLElement = function(t, e, n) {
        ...
        i(t, I.WILL_CHANGE) &&
          H({ effect: W, actionTypeId: o, elementApi: n })(t);
      }),
      ...
      (e.reduceListToGroup = function(t) {
        ...
        var o = i.actionItemGroups,
          ...
          s = function(t) {
            return (
              u.push((0, p.mergeIn)(t, ["config"], { delay: 0, duration: 0 })),
              t.id === n
            );
          };
        return (
    ...
    function L(t) {
      ...
      var N,
        ...
        w,
        x =
          (0, E.default)(n, "action.config.affectedElements", {})[_ || y] || {},
        P = Boolean(x.id || x.selector),
        D = n && u(C(n.target));
      if (
        (P
          ? ((N = x.limitAffectedElements), (L = D), (w = u(x)))
          : (L = w = u({ id: _, selector: y, selectorGuids: m })),
        n && R)
      ) {
        var M = r && (w || !0 === R) ? [r] : c(D);
        if (w) {
      ...
      switch (e.type) {
        ...
        case E:
          var y = e.payload,
            m = y.actionListId,
            S = y.isPlaying;
          return (0, i.setIn)(t, ["playbackState", m], S);
        case p:
          for (
            var A = e.payload,
              R = A.width,
      ...
      g = function(t, e) {
        ...
        for (var S = 0, A = o.length; S < A; S++) {
          ...
          if ((0 === S && (v = N[0]), m >= b)) {
            ...
            var C = o[S + 1],
              L = C && m !== b;
            (h = L ? C.actionItems[0] : null),
              L && ((I = b / 100), (T = (C.keyframe - b) / 100));
          }
        }
        var w = {};
        if (v && !h)
      ...
      O = function(t, e) {
        ...
        if (r && o) {
          ...
          if (s) {
            var S = y - a,
              A = g + O,
              R = E(Math.min(Math.max(0, S / A), 1));
            t = (0, i.set)(t, "verboseTimeElapsed", A * R);
          }
          if (m < 0) return t;
          var b = E(Math.min(Math.max(0, m / g), 1)),
            N = p(I, b),
            C = {},
            L = null;
          return (
      ...
      switch (e.type) {
        ...
        case s:
          var V = e.payload,
            X = V.instanceId,
            U = V.time;
          return (0, i.mergeIn)(t, [X], { active: !0, complete: !1, start: U });
        case f:
          var W = e.payload.instanceId;
          if (!t[W]) return t;
          for (
            var B = {}, k = Object.keys(t), H = k.length, Y = 0;
            Y < H;
            Y++
          ) {
            var z = k[Y];
  ...
  function(t, e, n) {
    ...
    t.exports = function(t, e, n) {
      ...
      function g(t) {
        var n = t - p;
        return void 0 === p || n >= e || n < 0 || (_ && t - v >= l);
      }
      function O() {
        var t = i();
        if (g(t)) return y(t);
      ...
      function m() {
        ...
        if (((s = arguments), (f = this), (p = t), n)) {
          if (void 0 === E)
            return (function(t) {
              return (v = t), (E = setTimeout(O, e)), h ? T(t) : d;
            })(p);
          if (_) return clearTimeout(E), (E = setTimeout(O, e)), T(p);
        }
    ...
    var c,
      ...
      pt = function(t) {
        return function(e) {
          ...
          n &&
            ((v = p > n.percentTop),
            (I = (h = n.scrollingDown !== v) ? p : n.anchorTop));
          var T = s === D ? p >= I + _ : p <= I - _,
            g = (0, l.default)({}, n, {
              percentTop: p,
              inBounds: T,
              anchorTop: I,
          ...
          return (n && T && (h || g.inBounds !== n.inBounds) && t(e, g)) || g;
        };
      },
      vt = function(t) {
        return function(e) {
      ...
      Tt =
        ...
        (0, o.default)(r, O, (0, l.default)({}, it, { types: "mousedown" })),
        ...
        (0, o.default)(r, P, {
          ...
          handler: function(t) {
            ...
            switch (u) {
              ...
              case K:
                var b = st(),
                  ...
                  L = b.scrollWidth,
                  w = b.scrollHeight;
                S = y ? Math.min(N + T, L) / L : Math.min(C + O, w) / w;
                break;
              case Y:
              default:
                A = q(o, s);
            ...
            return (
              m && (S > 0.95 || S < 0.05) && (S = Math.round(S)),
              (u !== Y || R || R !== a.elementHovered) &&
                ((S = f ? 1 - S : S),
                e.dispatch((0, h.parameterChanged)(A, S))),
              { elementHovered: R, clientX: p, clientY: _, pageX: T, pageY: O }
            );
          }
        }),
        (0, o.default)(r, H, {
        ...
        (0, o.default)(r, X, {
          ...
          handler: function(t) {
            ...
            if (d === z) {
              ...
              return (
                S !== o.scrollPercent &&
                  n.dispatch((0, h.parameterChanged)(p, S)),
                { scrollPercent: S }
              );
            }
            var A = q(i, p),
    ...
    t.exports = function(t) {
      return i(function(e) {
        ...
        for (t && e.reverse(); i--; ) {
          ...
          if (p && !h && "wrapper" == a(v)) var h = new r([], !0);
        }
        for (i = h ? i : n; ++i < n; ) {
          v = e[i];
          var _ = a(v),
      ...
      (t.exports = function(t) {
        ...
        function i(t) {
            ...
            if (a) {
              ...
              (i = l),
                Math.abs(p) > s &&
                  r &&
                  "" === String(r()) &&
                  (o("swipe", t, { direction: p > 0 ? "right" : "left" }), E()),
          ...
          t.addEventListener("touchstart", f, !1),
            ...
            t.addEventListener("touchcancel", E, !1),
            ...
            (this.destroy = function() {
              t.removeEventListener("touchstart", f, !1),
                ...
                t.removeEventListener("mouseout", E, !1),
                (t = null);
            });
        }
        function o(e, n, r) {
      ...
      (t.exports = function(t, e) {
        ...
        function v() {
          (n = f.find(d)).length &&
            (n.each(I),
            (u = null),
            a || (h(), r.resize.on(_), r.redraw.on(c.redraw)));
        }
        function h() {
        ...
        function I(e, n) {
          ...
          i.el.off(d),
            ...
            T(i),
            o
              ? (i.el.on("setting" + d, S(i)), m(i), (i.hasTimer = !1))
              : (i.el.on("swipe" + d, S(i)),
                i.left.on("tap" + d, O(i)),
                i.right.on("tap" + d, y(i)),
                i.config.autoplay &&
                  !i.hasTimer &&
                  ((i.hasTimer = !0),
                  (i.timerCount = 1),
                  (function t(e) {
                    ...
                    e.timerId = window.setTimeout(function() {
                      null == e.timerId || o || (y(e)(), t(e));
                    }, n.delay);
                  })(i))),
            i.nav.on("tap" + d, "> div", S(i)),
            l ||
              i.mask
                .contents()
                .filter(function() {
        ...
        function T(t) {
          ...
          if (
            ...
            g(t.el.attr("data-disable-swipe")) && (e.disableSwipe = !0),
        ...
        function S(n) {
          return function(i, a) {
            ...
            if (o && "setting" === i.type) {
              ...
              if ((T(n), b(n), null == a.select)) return;
              !(function(n, r) {
                var i = null;
                r === n.slides.length && (v(), b(n)),
                  e.each(n.anchors, function(e, n) {
                    t(e.els).each(function(e, o) {
                      t(o).index() === r && (i = n);
                    });
                  }),
                  null != i && A(n, { index: i, immediate: !0 });
              })(n, a.select);
            } else {
              if ("swipe" === i.type) {
        ...
        function A(e, n) {
          ...
          var l = e.offsetX || 0,
            ...
            y = "opacity " + g + "ms " + T,
            m = "transform " + g + "ms " + T;
          if ((o || (v.each(p.intro), _.each(p.outro)), n.immediate && !u))
            return s(v).set(E), void R();
          if (e.index !== e.previous) {
            if ("cross" === I) {
              var S = Math.round(g - g * r.crossOver),
                A = Math.round(g - S);
              return (
                (y = "opacity " + S + "ms " + T),
                s(h)
        ...
        function b(e) {
          ...
          var s = e.index;
          s >= n && (s = n - 1), A(e, { immediate: !0, index: s });
        }
        return (
          (c.ready = function() {
            (o = r.env("design")), v();
...
Webflow.require("ix2").init({
  events: {
    ...
    "e-3": {
      ...
      target: {
        selector: ".slide",
        originalId:
          "5d9a07cb6e7b48159a0df68d|c5559600-adb1-480d-445d-ea77d64c7d82",
        appliesTo: "CLASS"
      },
      config: {
        loop: false,
    ...
    "e-5": {
      ...
      target: {
        selector: ".nav-link",
        originalId:
          "5d9a07cb6e7b48159a0df68d|136665df-496a-f826-3bd2-b4e563165e44",
        appliesTo: "CLASS"
      },
      config: {
        loop: false,
    ...
    "e-7": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5d9a07cb6e7b48159a0df68d|3447d321-6754-14fb-36f5-95ab2512745b"
      },
      config: {
        loop: false,
        playInReverse: false,
  ...
  actionLists: {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|3690f93e-35d3-f38a-5af4-e227de27a2e8"
                },
                value: 0,
                unit: ""
              }
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|1ceae69d-95c1-d3bd-4748-87616905d887"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|1b7dc3a6-2093-d531-762e-14b98581c324"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|d8b82e14-a989-c977-5689-3af7f38e6487"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|206cb41c-cce6-b144-fa02-26f107c0ac50"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|c8b7a26b-33ae-4e34-2e11-3b874835b3a1"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|d71e01f0-7d3e-489b-312d-a2df146f4eff"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|b285493b-4dbd-8e70-861c-b296f13f1ba6"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|47c6e36c-94b2-3b67-58af-6347bd7f78cb"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|c35f761c-7d5c-06e6-f2f4-2905d07d5707"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|993a1226-894c-d823-abcc-48b76d299ffe"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|8503b44a-5bd3-6955-78ac-24ad0a618f5a"
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "VH"
    ...
    "a-2": {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".img-container-1",
                  selectorGuids: ["ff4743f7-2a33-769f-b8f2-cd805558d0a1"]
                },
                xValue: 30,
                xUnit: "%",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".servies-block-one",
                  selectorGuids: ["4f588e01-b705-6f20-52df-0e126242f57e"]
                },
                value: 0,
                unit: ""
              }
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".about-text-heading",
                  selectorGuids: ["fb689623-a094-23f3-a4c9-6d8b3de369bf"]
                },
                xValue: 20,
                xUnit: "%",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".heading",
                  selectorGuids: ["235c5607-df9e-42c2-8173-f984d15a514f"]
                },
                yValue: 20,
                xUnit: "%",
                yUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".img-container-2",
                  selectorGuids: ["98b3de71-c3e4-7a09-c74d-b00e0f1794d8"]
                },
                xValue: 30,
                xUnit: "%",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".img-container-3",
                  selectorGuids: ["c9cd3fb5-1d5b-6db7-b545-f52b1b46253e"]
                },
                xValue: 30,
                xUnit: "%",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".paragraph",
                  selectorGuids: ["43c3d157-e086-3a70-2d14-a07d1a53f2fa"]
                },
                yValue: 20,
                xUnit: "%",
                yUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["0077135d-78e7-9f63-ffcf-765458f14cb4"]
                },
                xValue: 20,
                xUnit: "%",
                yUnit: "PX",
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  selector: ".separate",
                  selectorGuids: ["46fad9a8-8204-2571-c8fb-d55ab01aad0f"]
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "PX",
      ...
      createdOn: 1570398448152,
      useFirstGroupAsInitialState: true
    },
    "a-3": {
      id: "a-3",
      title: "slide animation 2",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".nav-link",
                  selectorGuids: ["d9f89990-7edb-778c-6756-2c697678e9e4"]
                },
                yValue: -50,
                xUnit: "PX",
                yUnit: "%",
    ...
    "a-6": {
      id: "a-6",
      title: "Mobile menu click animation",
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id:
                    "5d9a07cb6e7b48159a0df68d|a2dc795a-3a75-b150-aa05-73d45b8f9bda"
                },
                yValue: 0,
                xUnit: "PX",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id:
                    "5d9a07cb6e7b48159a0df68d|b3747fa9-f069-a017-a6d5-ba013e11ccbc"
                },
                widthValue: 23,
                heightValue: 17,
                widthUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|8937c891-ad68-ef9d-2c71-49ec6bbc1e98"
                },
                value: 0,
                unit: ""
              }
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|1b90f01b-4256-bd8a-d65a-ead1807e1a02"
                },
                xValue: 0,
                xUnit: "PX",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|9dbc603a-3464-6652-0120-25c0f6406b2a"
                },
                xValue: 0,
                xUnit: "PX",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|023ce8be-c868-11b9-9f90-c9ae409b1e1f"
                },
                xValue: 0,
                xUnit: "PX",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5d9a07cb6e7b48159a0df68d|13b7ff82-804c-b1f1-15fb-c7d134314da9"
                },
                xValue: 0,
                xUnit: "PX",
                yUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  id:
                    "5d9a07cb6e7b48159a0df68d|572556e0-55ca-5919-6b2b-b6a5ff75ec92"
                },
                widthValue: 130,
                widthUnit: "%",
                heightUnit: "PX"
      ...
      createdOn: 1570451154941,
      useFirstGroupAsInitialState: true
    },
    "a-7": {
      id: "a-7",
      title: "Mobile menu click animation 2",
      actionItemGroups: [
        {
          actionItems: [
            {
